...
#for data in "Cornell" "Texas" "Wisconsin" "reed98" "amherst41" "penn94" "Roman-empire" "cornell5" "Squirrel" "johnshopkins55" "Actor" "Minesweeper" "Questions" "Chameleon" "Tolokers" "Amazon-ratings" "Cora" "DBLP" "Computers" "PubMed" "Cora_ML" "SmallCora" "CS" "Photo" "Physics" "CiteSeer" "wiki"; do
#     for dataset in "Cornell" "Texas" "Wisconsin"; do
#genius pokec arxiv-year ogbn-proteins Reddit

for model in "gcn"; do
#     for data in "Cornell" "Texas" "Wisconsin"; do
    for data in "Tolokers"; do    #genius pokec arxiv-year ogbn-proteins Reddit
...
# for model in "h2gcn"; do
# #     for data in "Cornell" "Texas" "Wisconsin"; do
#     for data in "Roman-empire" "johnshopkins55" "cornell5" "pokec" ; do    #genius pokec arxiv-year ogbn-proteins Reddit
#         python main_stgnn.py --method GraNet \
#                              --optimizer adam \
#                              --sparse-init ERK \
#                              --iters 3 \
...
# do
#     for data in cora citeseer pubmed Cornell Texas Wisconsin Actor CS Physics Computers Photo WikiCS ogbn-arxiv
#     do
#         python main_stgnn.py --method GraNet \
#                              --optimizer adam \
#                              --sparse-init ERK \
