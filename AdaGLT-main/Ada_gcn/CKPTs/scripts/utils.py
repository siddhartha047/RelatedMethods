...
from ICML_SPARSIFICATION.scripts.baseline_dataset_bridge import infer_embedding_dim, load_dense_tensors
...
def load_citation(dataset_str="cora", normalization="AugNormAdj", porting_to_torch=True,data_path=datadir, task_type="semi"):
    ...
    """
    data_root = os.environ.get("BASELINE_DATA_ROOT", "/scratch/gilbreth/das90/")
