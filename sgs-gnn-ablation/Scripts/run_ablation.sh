    ...
    #for dataset in "SmallCora" "Cora" "CiteSeer" "johnshopkins55" "Squirrel" "Roman-empire"; do
        ...
        for GNN in "GCN"; do
            ...
            for edgeGNN in "GCN"; do
                echo ----EdgeGNN---$edgeGNN------
                python main.py --dataset $dataset --mode $mode --runs 1 --epochs 250 --save_csv True --edge_mlp_type $edgeGNN --GNN $GNN --log False --sparse_edge_mlp True --conditional False --reg1 True --reg2 True --calc_homophily True --ER True       
            done
        done
        echo ---------end--------------
    done 
