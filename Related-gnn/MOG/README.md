...
python main.py --k_list 0.2 0.2 0.2 --expert_select 3 --dataset SmallCora --log_steps 10 --epochs 200 --run 5 >> logMOG.txt

python main.py --k_list 0.2 0.2 0.2 --expert_select 3 --dataset SmallCora --log_steps 10 --epochs 1 --run 3

python main.py --k_list 0.2 0.2 0.2 --expert_select 3 --dataset Cora --log_steps 10 --epochs 1 --run 1
