...
def load_nc_dataset(args):
    ...
    elif dataname == 'SmallCora':
        dataset = load_planetoid_dataset('Cora', args.no_feat_norm, dataset_name='SmallCora')
...
def load_planetoid_dataset(name, no_feat_norm=False, dataset_name=None):
    if not no_feat_norm:
    ...
    dataset = NCDataset(dataset_name or name)
