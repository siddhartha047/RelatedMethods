...
parser.add_argument('-d', '--data', type=str, default=None, help='Dataset name override.')
...
parser.add_argument('-e', '--epochs', type=int, default=None, help='Epoch override.')
parser.add_argument('--edge_keep_ratio', type=float, default=None, help='Exact edge retention ratio override.')
args = prepare_opt(parser)

num_thread = 0 if args.data in ['cora', 'smallcora', 'citeseer', 'pubmed'] else 8
...
feat, labels, idx, nfeat, nclass, macs_pre, time_pre = load_embedding(datastr=args.data,
                ...
                edge_keep_ratio=getattr(args, 'edge_keep_ratio', None))
