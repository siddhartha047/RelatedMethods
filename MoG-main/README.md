...
python main.py --conv_encode_edge --use_one_hot_encoding --num_layers 28 --block res+ --gcn_aggr max --k_list 1 --expert_select 1

python main.py --k_list 0.7 0.5 0.3 --expert_select 2

python main.py --gcn_aggr max --k_list 0.9 0.7 0.5 --expert_select 2


# For Agni

python main.py --k_list 0.2 0.2 0.2 --expert_select 3 --dataset SmallCora --log_steps 10 --epochs 10 --run 1

"CS"	"Questions"	"Amazon-ratings"	"johnshopkins55"	"amherst41" "Tolokers" "Physics"


python main.py --k_list 0.2 0.2 0.2 --expert_select 3 --dataset CS --log_steps 10 --epochs 20 --run 1


python main.py --k_list 0.2 0.2 0.2 --expert_select 3 --log_steps 10 --epochs 20 --run 1 --dataset amherst41
