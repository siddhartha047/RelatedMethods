...
args.add_argument('--dataset', default='SmallCora')
...
args.add_argument('--dim_1', type = int,default=64,help='Size of output dim (final is 2x this, if using concat)')
args.add_argument('--dim_2', type = int,default=32,help='Size of output dim (final is 2x this, if using concat)')
...
args.add_argument('--nb_noising_edges', type=int, default=0)
...
if gpus:
    try:
        ...
        tf.config.experimental.set_visible_devices(gpus[real_device], 'GPU')
