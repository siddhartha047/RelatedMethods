...
def my_get_data(root: str, name: str, follow_by_subgraph_sampling: bool=False, enable_sparsify: bool=False, random_sparsify: bool=True, target_ratio=None) -> Tuple[Data, int, int]:

    data, dataset  = load_pyg_data(root, name)
    ...
    if enable_sparsify:
        data = maybe_sparsfication(data, name, follow_by_subgraph_sampling, random_sparsify, target_ratio=target_ratio)
